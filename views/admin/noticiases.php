...
<body>
        ...
        <div class="d-flex px-1" style="align-items: center;">
            ...
            <div class="ms-3">
                     ...
                     <select class="form-select" onchange="cambiarIdioma(this.value)">
                        ...
                        <option  data-image='<?php echo WEBURL?>/assets/img/icons/en2.png'value="noticias" >Ingles</option>
                    </select>
                ...
                <?php } ?>
                <button class="btn btn-success text-white" onclick="location.href = '/admin/editores'"><i class="fas fa-plus"></i>&nbsp; Nueva noticia</button>
            </div>
        </div>
        <hr>
        <div class="row">
                ...
                <div class="col-xxl-3 col-md-4 my-3 px-3" id="card-<?php echo $val['idnot'] ?>">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-footer gx-5">
                            <a href="/admin/editores/vista/<?php echo $val['idnot'] ?>" class="btn btn-sm btn-outline-success me-1" title="Editar"><i class="fas fa-pencil-alt"></i></a>
    ...
    <script>
        const cambiarCategoria = (val) => {
            location.href = '/admin/noticiases/' + val;
        }
        ...
        const eliminarNoticia = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let uri = `/admin/noticiases/eliminar/${id}`;
                    fetch(uri, {
                        method: "GET"
                    }).then(function(res) {
                        return res.text()
        ...
        const cambiarEstado = (id) => {
            ...
            estado = estado ? 'S' : 'N';
            let uri = `/admin/noticiases/estado/${id}/${estado}`;
            fetch(uri, {
                method: "GET"
            }).then(function(res) {
                return res.text()
