...
<div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2 class="  mb-3" style="color:var(--color1);font-weight:bold;">EXAMINATION AND DOCUMENT EXCHANGE PLATFORM</h2>
                <!--<p class="color-secu font-weight-bold" style="color:var(--color4);"><i class="fa fa-calendar" aria-hidden="true" ></i>&nbsp; 2021-01-15</p>-->
                <hr>
                <div class="content p-2">
                <center> <img src="./assets/img/industrias/examination.jpg" class="img-fluid "alt=""></center>
                <br>
                <br>
...
<p><br /><strong>Technologies used</strong><span style="font-weight: 400;">: .NET, ASP, MVC, Web Services, Java, J2EE.</span></p>
