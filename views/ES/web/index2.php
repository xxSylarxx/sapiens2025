...
<head>
    ...
    <link rel="shortcut icon" href="./assets/img/icons/escudo2.png" type="image/x-icon">
...
<body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="./assets/img/banner/banner00001.jpg" class="d-block crop w-100" style="height:80vh;" id="img-banner">
                </div>
                <div class="carousel-item">
                    <div class="container div-banner">
                        <div class="">
                            <h2 class="tittle-banner1">We bring speed, efficiency and 
                                expertise to your software <br>development team with the 
                                trust and commitment you need.<br> Take advantage of nearshore 
                                advantages for flexibility and value. </h2>
                    ...
                    <img src="./assets/img/banner/banner00002.jpg" class="d-block crop w-100" style="height:80vh;" id="img-banner" >
                </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="form-group pt-2">
                                        ...
                                        <div style="text-align:center;">
                                            ...
                                            <br>
                                            <div>
                                                <span>"By sending this form I confirm that I have read and accept Sapiens Consulting <a href="policy.php" style="text-decoration:underline;" target="_blank"> Privacy Policy </a> &nbsp;” </span>
                                            </div>
                                            <br>
                                            <br>
    ...
    <section id="section-ourservices" class="container-fluid p-0">
                ...
                <div class="carousel-inner " style="height:500px;">
                    <div class="carousel-item active">
                        <div class="container">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-12 col-lg-4 p-0 hvr-float">
                                    <a href="recognition.php" class="card crop " style="height:60%;" target="_blank">
                                        <span class="news">Manufacturing</span>
                                        <img src="./assets/img/industrias/recognition.jpg" width="100%" height="460">
                                        <div class="card-body">
                                            <p>Sapiens | </p>
                                            <h5>Recognition System</h5>
                                            <p style="font-size:15px;">
                                                The client, a multinational public company in the medical device manufacturing industry,...</p>
                                        </div>
                                        <div class="card-footer" style="background-color:transparent;">
                                ...
                                <div class="col-12 col-lg-4 p-0 hvr-float">
                                    <a href="biometric.php" class="card crop " style="height:60%;" target="_blank">
                                        <span class="news">Government</span>
                                        <img src="./assets/img/industrias/biometric.jpg" width="100%" height="460">
                                        <div class="card-body">
                                            <p>Sapiens | </p>
                                            <h5>Biometric System</h5>
                                            <p style="font-size:15px;">
                                                The U.S. government and private organizations had been involved in developing security technology for computer...</p>
                                        </div>
                                        <div class="card-footer" style="background-color:transparent;">
                                            <h6>Read More&nbsp;<i class="fas fa-angle-right my-auto"></i></h6>
                                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="container">
                            <div class="row d-flex justify-content-center">
                                <div class="col-12 col-lg-4 p-0 hvr-float">
                                    <a href="inspection.php" class="card crop " style="height:60%;" target="_blank">
                                        <span class="news">Health Care</span>
                                        <img src="./assets/img/industrias/inspection.jpg" width="100%" height="460">
                                        <div class="card-body">
                                            <p>Sapiens | </p>
                                            <h5>Facilities Inspection System </h5>
                                            <p style="font-size:15px;">The client’s main goal was to assess and certify more than 4,500 health care providers or entities. The assessment of the health care..</p>
                                        </div>
                                        <div class="card-footer" style="background-color:transparent;">
                                            <h6>Read More&nbsp;<i class="fas fa-angle-right my-auto"></i></h6>
                                        </div>
                                ...
                                <div class="col-12 col-lg-4 p-0 hvr-float">
                                    <a href="examination.php" class="card crop " style="height:60%;" target="_blank">
                                        <span class="news">Banking</span>
                                        <img src="./assets/img/industrias/examination.jpg" width="100%" height="460">
                                        <div class="card-body">
                                            <p>Sapiens | </p>
                                            <h5>Examination and Document Exchange Platform</h5>
                                            <p style="font-size:15px;">
                                                The Client required to develop a platform ...</p>
                                        </div>
                                        <div class="card-footer" style="background-color:transparent;">
                                            <h6>Read More&nbsp;<i class="fas fa-angle-right "></i></h6>
                                        </div>
