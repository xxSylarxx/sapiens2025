                                ...
                                <div class="container div-banner">
                                    ...
                                    <h2 class="tittle-banner1">Gana Agilidad y Amplía su Experiencia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>con Desarrolladores en Demanda </h2>
                                        ...
                                        <button class="button2">
                                            <a class="" href="" data-bs-toggle="modal" data-bs-target="#modalcontact">Contáctanos</a>
                                        </button>
                                    </div>
                                </div>
                            <?php } else if ($key == 1) { ?>
            ...
            <div class="row d-flex justify-content-around">
                ...
                <div id="about" class="col-lg-5 my-auto ">
                    ...
                    <p style="text-align:justify;">Sapiens Consulting is a premier consulting firm founded by a group
                        of professionals in technology and management consulting. </p>
                    <p style="text-align:justify;">
                        Nuestros principales activos son nuestros talentosos y calificados recursos. La experiencia y
                        valor que ofrecemos a nuestros clientes les permite desarrollar sus capacidades técnicas para que estos
                        puedan lograr una ventaja competitiva sostenible.Brindamos cuatro líneas de negocios: outsourcing de personal de
                        TI, desarrollo de aplicaciones personalizadas, desarrollo de aplicaciones móviles, y administración y soporte de aplicaciones.</p>
            ...
            <div class="container__cards">
                <div class="card_style1">
                    ...
                    <div class="description">
                        <h2 style="color:black;">Outsourcing de Personal de TI </h2>
                        <p>
                ...
                <div class="card_style1">
                    ...
                    <div class="description">
                        <h2 style="color:black;">Desarrollo de Aplicaciones </h2>
                        <p>
                ...
                <div class="card_style1 ">
                    ...
                    <div class="description">
                        <h2 style="color:black;">Desarrollo de Aplicaciones Móviles</h2>
                ...
                <div class="card_style1">
                    ...
                    <div class="description">
                        <h2 style="color:black;">Administración y Soporte de Aplicaciones</h2>
                        <p>Ayudamos a los clientes a administrar y brindar soporte a sus aplicaciones e infraestructura tecnológica para aprovechar al máximo su inversión.
                        </p>
                        <br>
                        <br>
                        <br>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div style="text-align:center;color:white;font-size:18px;">
                        <p>Sapiens Consulting está continuamente en la búsqueda de recursos con habilidades
                            técnicas, excelente actitud y automotivación. </p>
                        <p>Nuestro proceso de selección es exigente e incluye pruebas de aptitud,
                            evaluación técnica, habilidades de comunicación y validación de referencias
                            profesionales. Nuestro equipo está formado únicamente por profesionales con estudios
                            universitarios. Buscamos personas dinámicas, orientadas a resultados, interesadas en
                            trabajar en un ambiente reflexivo, colaborativo, innovador y amigable. Buscamos recursos
                            principalmente en las siguientes áreas: Desarrolladores, Analistas de Sistemas, Administrador
                            de Bases de Datos, Expertos en BPM, Gerentes de Proyectos</p>
                    </div>
                    <br>
