...
<section style="background-color:white;" id="industrias" >;
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
                 ...
                 <h2 style="color:var(--color7);font-weight:bold;">Banking</h2>
    ...
    <div class="carousel-item active">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-lg-4 mt-3">
                <a href="examination.php" class="card crop h-75">
                    <span class="news">Banking</span>
                        <img src="./assets/img/industrias/examination.jpg" width="100%" height="460">
                    <div class="card-body">
                        <p>Awari | </p>
                        <h4>Examination and Document Exchange Platform</h4>
                        <p>
                            The Client required to develop a platform to review and exchange documents that be...</p>
                    </div>
