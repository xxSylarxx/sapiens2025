...
<section style="background-color:white;" id="industrias" >;
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
                 ...
                 <h2 style="color:var(--color7);font-weight:bold;">Government</h2>
    ...
    <div class="carousel-item active">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-lg-4 mt-3">
                <a href="biometric.php" class="card crop h-75">
            ...
            <div class="col-12 col-lg-4 mt-3">
                <a href="security.php" class="card crop h-75">
                    ...
                    <div class="card-body">
                        ...
                        <p>The client’s technology platform is very complex with a core system and multiple systems interconnected.</p>
                    </div>
                    <div class="card-footer">
                        <h5>Read More&nbsp;<i class="fas fa-angle-right my-auto"></i></h5>
                    </div>
