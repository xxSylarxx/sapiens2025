...
<section style="background-color:white;" id="industrias" >;
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
                 ...
                 <h2 style="color:var(--color7);font-weight:bold;">Telecomm Manufacturing</h2>
    ...
    <div class="carousel-item active">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-lg-4 mt-3">
                <a href="recognition.php" class="card crop h-75">
                    <span class="news">Telecomm Manufacturing</span>
                    <img src="./assets/img/industrias/recognition.jpg" width="100%" height="460">
                    <div class="card-body">
                        <p>Sapiens | </p>
                        <h4>Recognition System</h4>
                        <p>
                             The client, a multinational public company in the medical device manufacturing industry, required a technology solution to support...</p>
                    </div>
