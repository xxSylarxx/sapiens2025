    ...
    <nav class="navbar navbar-expand-lg navbar-light py-0">
        <a class="navbar-brand animate__animated animate__zoomIn" href="/">
            <div class="d-flex flex-row align-items-center" id="escudo">
                <img src="./assets/img/icons/escudo.png" class="mr-3" height="90" id="">
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                <li class="nav-item ">
                    <a class="nav-link fw-bold <?= $active1 ?>" href="/"><?php echo $lang === 'ES' ? 'INICIO' : 'HOME'; ?></a>
                </li>
                <li class="nav-item fw-bold">
                    <a class="nav-link <?= $active2 ?>" href="/index.php#div-about"><?php echo $lang === 'ES' ? 'NOSOTROS' : 'ABOUTS US'; ?></a>
                </li>
                <li class="nav-item fw-bold">
                    <a class="nav-link <?= $active3 ?>" href="/index.php#section-ourservices"><?php echo $lang === 'ES' ? 'SERVICIOS' : 'SERVICES'; ?></a>
                </li>
                <li class="nav-item fw-bold">
                    <a class="nav-link <?= $active4 ?>" href="/index.php#partners"><?php echo $lang === 'ES' ? 'PARTNERS' : 'PARTNERS'; ?></a>
                </li>
                <li class="nav-item fw-bold">
                    <a class="nav-link <?= $active5 ?>" href="/index.php#div-industrias"><?php echo $lang === 'ES' ? 'PROYECTOS' : 'PROJECTS'; ?></a>
                </li>
                <li class="nav-item fw-bold">
                    <a class="nav-link <?= $active6 ?>" href="/index.php#careers"><?php echo $lang === 'ES' ? 'CARRERAS' : 'CAREERS'; ?></a>
                </li>
                ...
                <li class="nav-item dropdown ">
                    <div id="cespanol">
                        <a type="button" onclick="cambiarIdioma('ES')"><img src="<?php echo WEBURL ?>/assets/img/icons/esp2.png" alt=""></a>
                    </div>
                </li>
            </ul>
        </div>
